...
$botToken = "7418033257:AAHOWWwdqqnuqYNXNxzp70zBNDLoahPLGTc";
...
$emojid = '❌';
$emojil = '✅';
$owner = "<b>[<a href='t.me/MkDarkHub'>↯</a>]</b> 𝐃𝐞𝐯 :- <a href='t.me/DarkMikex1'>⋉ 𝑀𝐼𝘒𝐸 ⋊</a>";
$botu = "𝐁𝐨𝐭 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ↯ @MkDarkHub";
$bota = "<b>[<a href='t.me/MkDarkHub'>↯</a>]</b> 𝐃𝐞𝐯 :- <a href='t.me/DarkMikex1'>⋉ 𝑀𝐼𝘒𝐸 ⋊</a>";$eror = "Error ❌";
...
if ($cdata2 == "back2") {
    $gatesText = "𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝑴𝒊𝒌𝒆'𝒔 𝑪𝒉𝒆𝒄𝒌𝒆𝒓. ⚠️ 𝑩𝒖𝒚 𝑻𝒉𝒆 𝑷𝒍𝒂𝒏 𝑭𝒊𝒓𝒔𝒕.";
    ...
    $videoUrl = "https://t.me/MkDarkHub/1163";
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/DarkMikeX1'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/DarkMikeX1"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝑶𝒘𝒏𝒆𝒓", 'url' => "t.me/DarkMikeX1"], ['text' => "𝑪𝒉𝒂𝒏𝒏𝒆𝒍", 'url' => "https://t.me/MkDarkHub"]],
        [['text' => "𝑮𝒐 𝑩𝒂𝒄𝒌", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "back2") {
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/MkDarkHub/1163"; 
